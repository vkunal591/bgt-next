    ...
    return (
        <div className="max-w-7xl mx-auto p-4 lg:p-16">
            ...
            <InfoBannerSection
                ...
                subTitleClass='text-white lg:text-dark-primary text-5xl font-bold tracking-wide'
                titleColor="text-white lg:text-dark-primary text-3xl font-medium"
                textColor="text-white lg:text-dark-primary"
